...
public class Transfers {
    ...
    public void setPurpose(Entity sender, String purpose){
        ...
        byte[] encryptedBytePurpose = cryptor.encrypt(purpose, cryptor.hexToBytes(password));
    ...
    public String getPurpose(Entity sender){
        ...
        return cryptor.decrypt(encryptedPurpose, encryptedPassword);
    }
